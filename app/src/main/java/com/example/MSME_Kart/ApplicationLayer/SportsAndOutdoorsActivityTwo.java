...
import com.example.MSME_Kart.BusinessObjects.Size;
import com.example.MSME_Kart.BusinessObjects.SizeArrayAdapter;
...
public class SportsAndOutdoorsActivityTwo extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
        ...
        try {
            switch (item.getItemId()) {
                ...
                case R.id.home: // If the sports and outdoors category is chosen
                    Intent sportsIntent = new Intent(SportsAndOutdoorsActivityTwo.this, MainActivity.class); // Take user to the sports and outdoors activity
    ...
    private void logout() { // Logout the user
        ...
        startActivity(new Intent(SportsAndOutdoorsActivityTwo.this, LoginActivity.class)); // Take user to login activity
    }
