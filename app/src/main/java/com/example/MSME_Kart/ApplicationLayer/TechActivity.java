...
import com.example.MSME_Kart.BusinessObjects.ColourArrayAdapter;
import com.example.MSME_Kart.BusinessObjects.Products;
import com.example.MSME_Kart.BusinessObjects.QuantitiesArrayAdapter;
import com.example.MSME_Kart.BusinessObjects.SizesAdapter;
...
public class TechActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.firstProductColour = findViewById(R.id.firstProductColorText);
        ...
        this.firstProductColourOptions = findViewById(R.id.firstColourSpinner);
        this.firstProductQuantityOptions = findViewById(R.id.firstQuantitySpinner);
        this.firstAddToBasketButton = findViewById(R.id.thirdAddToBasketBtn);
            ...
            public void onClick(View secondButton) {
                ...
                if (secondButton.getId() == R.id.secondAddToBasketBtn) { // If the second add to basket button is clicked
                    ...
                    if (secondProductColourOptions.getSelectedItemPosition() == 0 || secondProductQuantityOptions.getSelectedItemPosition() == 0 || secondProductSizesMenu.getSelectedItemPosition() == 0) {
                        ...
                        secondProductColourError.setCancelable(true);
                    } 
    ...
    public boolean onOptionsItemSelected(MenuItem item) { // Routine that gets an item selected from the menu
        ...
        try {
            ...
            switch (item.getItemId()) {
                ...
                case R.id.home:
                    Intent sportsIntent = new Intent(TechActivity.this, MainActivity.class); // Take user to the sports and outdoors activity
    ...
    private void logout() { // Logout the user
        ...
        startActivity(new Intent(TechActivity.this, LoginActivity.class)); // Take user to login activity
    }
