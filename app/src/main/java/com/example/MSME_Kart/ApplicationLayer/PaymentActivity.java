...
import com.example.MSME_Kart.BusinessObjects.Months;
import com.example.MSME_Kart.BusinessObjects.MonthsArrayAdapter;
import com.example.MSME_Kart.BusinessObjects.Products;
import com.example.MSME_Kart.BusinessObjects.SendPaymentInvoiceAPI;
import com.example.MSME_Kart.BusinessObjects.Years;
import com.example.MSME_Kart.BusinessObjects.YearsArrayAdapter;
import com.example.MSME_Kart.DataLayer.PaymentDatabase;
        ...
        try {
            switch (item.getItemId()) {
                ...
                case R.id.home: // If the sports and outdoors category is chosen
                    Intent sportsIntent = new Intent(PaymentActivity.this, MainActivity.class); // Take user to the sports and outdoors activity
