...
public class ClothingActivityTwo extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
        ...
        try {
            switch (item.getItemId()) {
                ...
                case R.id.home: // If the sports and outdoors category is chosen
                    Intent sportsIntent = new Intent(ClothingActivityTwo.this, MainActivity.class); // Take user to the sports and outdoors activity
    ...
    private void logout() { // Logout the user
        ...
        startActivity(new Intent(ClothingActivityTwo.this, LoginActivity.class)); // Take user to login activity
    }
